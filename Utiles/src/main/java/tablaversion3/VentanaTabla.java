...
public class VentanaTabla extends JFrame implements MouseListener {
    ...
    public VentanaTabla() {
        ...
        listaPersonas.add(new PersonaVo("1234", "Cristian David Henao", "Calle 2# 23-09 Armenia", "7564323", "Ingeniero", 23, 2.5, 4.3, 3.0, (2.5 + 4.3 + 3) / 33));
        listaPersonas.add(new PersonaVo("3455", "Juan Camilo Perez", "Calle 2# 23-09 Armenia", "7564323", "Ingeniero", 0, 0, 0, 0, 0));
        listaPersonas.add(new PersonaVo("3214", "Marlon Guapacha", "Calle 2# 23-09 Armenia", "7564323", "Ingeniero", 0, 0, 0, 0, 0));
        listaPersonas.add(new PersonaVo("7886", "Marina Marin", "Calle 2# 23-09 Armenia", "7564323", "Ingeniero", 0, 0, 0, 0, 0));
        listaPersonas.add(new PersonaVo("4331", "Juliana Henao", "Calle 2# 23-09 Armenia", "7564323", "Ingeniero", 0, 0, 0, 0, 0));
        listaPersonas.add(new PersonaVo("98675", "David Henao", "Calle 2# 23-09 Armenia", "7564323", "Ingeniero", 0, 0, 0, 0, 0));
        listaPersonas.add(new PersonaVo("1221", "Cristian mendez Henao", "Calle 2# 23-09 Armenia", "7564323", "Ingeniero", 0, 0, 0, 0, 0));
        construirTabla();
    }
...
//que luego se manda a construir la tabla
        Object[][] data = obtenerMatrizDatos(titulos);
...
// @return
//
    private Object[][] obtenerMatrizDatos(String[] titulosList) {

//se crea la matriz donde las filas son dinamicas pues corresponde
//a todos los usuarios, mientras que las columnas son estaticas
// correspondiendo a las columnas definidas por defecto
//
        String informacion[][] = new String[listaPersonas.size()][titulosList.length];
...
//
    private void construirTabla(String[] titulos, Object[][] data) {
        ...
        tablaPersonas.getColumnModel().getColumn(Utilidades.EDAD).setCellRenderer(new GestionCeldas(new TipoColumna("numerico", "Edad")));
        tablaPersonas.getColumnModel().getColumn(Utilidades.NOTA1).setCellRenderer(new GestionCeldas(new TipoColumna("numerico", "Nota1")));
        tablaPersonas.getColumnModel().getColumn(Utilidades.NOTA2).setCellRenderer(new GestionCeldas(new TipoColumna("numerico", "Nota2")));
        tablaPersonas.getColumnModel().getColumn(Utilidades.NOTA3).setCellRenderer(new GestionCeldas(new TipoColumna("numerico", "Nota3")));
        tablaPersonas.getColumnModel().getColumn(Utilidades.PROMEDIO).setCellRenderer(new GestionCeldas(new TipoColumna("numerico", "Promedio")));
        tablaPersonas.getColumnModel().getColumn(Utilidades.PERFIL).setCellRenderer(new GestionCeldas(new TipoColumna("icono", "Ver perfil")));
        tablaPersonas.getColumnModel().getColumn(Utilidades.EVENTO).setCellRenderer(new GestionCeldas(new TipoColumna("icono", "Eliminar")));
        ...
        for (int i = 0; i < titulos.length - 7; i++) {//se resta 7 porque las ultimas 7 columnas se definen arriba
            ...
            tablaPersonas.getColumnModel().getColumn(i).setCellRenderer(new GestionCeldas(new TipoColumna("texto", "hola")));
        }
        ...
        tablaPersonas.getColumnModel().getColumn(Utilidades.PERFIL).setPreferredWidth(100);//accion perfil 30
        tablaPersonas.getColumnModel().getColumn(Utilidades.EVENTO).setPreferredWidth(100);//accion evento 30
